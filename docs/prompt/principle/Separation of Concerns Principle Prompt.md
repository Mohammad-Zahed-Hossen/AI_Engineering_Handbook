...
# AENS Principle Resource Prompt — Separation of Concerns
...
* **Target Principle Name:** `Separation of Concerns`
* **Principle Category:** `systems`
* **Problem Statement:** AI engineering systems become unmaintainable when responsibilities are not clearly separated, leading to tight coupling, difficult debugging, and scaling challenges.
...
Never explain:
* what separation means in general
* basic software engineering concepts
* beginner API concepts
* what "concerns" are at a basic level
...
> **"What is the Separation of Concerns principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the Separation of Concerns principle in AI engineering systems, focusing on maintainability, debugging, and scalability benefits.

---

## Problem

State the engineering problem: When AI system components (data loading, model logic, training loop, logging, evaluation) are tightly coupled, changes to one component require changes to others, making systems brittle and difficult to maintain.
