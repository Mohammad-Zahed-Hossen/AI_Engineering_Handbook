...
# AENS Principle Resource Prompt — Bias–Variance Tradeoff
...
* **Target Principle Name:** `Bias–Variance Tradeoff`
* **Principle Category:** `learning_theory`
* **Problem Statement:** AI models fail to generalize when engineers cannot correctly diagnose and balance the tension between underfitting (high bias) and overfitting (high variance), leading to suboptimal model performance, wasted compute, and poor production outcomes.
...
Never explain:
* what bias or variance means in general
* basic software engineering concepts
* beginner API concepts
* what the "bias-variance tradeoff" is at a basic level
...
> **"What is the Bias–Variance Tradeoff principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the Bias–Variance Tradeoff principle in AI engineering systems, focusing on maintainability, debugging, and scalability benefits.

---

## Problem

State the engineering problem: When AI models exhibit high bias (systematic underfitting) or high variance (overfitting to training noise), engineers lack the diagnostic framework to identify which error source dominates, leading to misguided interventions, wasted training cycles, and models that fail to generalize to production data.
