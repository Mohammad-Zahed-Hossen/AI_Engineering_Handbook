...
# AENS Principle Resource Prompt — Maximum Likelihood Estimation
...
* **Target Principle Name:** `Maximum Likelihood Estimation`
* **Principle Category:** `learning_theory`
* **Problem Statement:** AI models produce unreliable probability estimates and poor parameter inference when engineers do not understand the assumptions and limitations of maximum likelihood estimation, leading to overconfident predictions, biased parameters, and incorrect uncertainty quantification in production.
...
Never explain:
* what maximum likelihood means in general
* basic software engineering concepts
* beginner API concepts
* what "maximum likelihood estimation" is at a basic level
...
> **"What is the Maximum Likelihood Estimation principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the Maximum Likelihood Estimation principle in AI engineering systems, focusing on parameter inference, probabilistic modeling, and statistical consistency benefits.

---

## Problem

State the engineering problem: When AI models are trained by minimizing loss functions without understanding that many standard objectives are derived from maximum likelihood assumptions, engineers cannot diagnose when those assumptions are violated—such as misspecified likelihoods, small sample sizes, or non-iid data—leading to biased parameters, miscalibrated uncertainties, and incorrect inference in production.
...
* `id` - Use "maximum-likelihood-estimation"
