...
# AENS Principle Resource Prompt — DRY
...
* **Target Principle Name:** `DRY`
* **Principle Category:** `systems`
* **Problem Statement:** AI engineering systems become unmaintainable and error-prone when the same logic, configuration, or data transformations are duplicated across multiple components, leading to inconsistent behavior, hidden dependencies, and change amplification where a single update requires modifications in dozens of places.
...
Never explain:
* what DRY means in general
* basic software engineering concepts
* beginner API concepts
* what "DRY" is at a basic level
...
> **"What is the DRY principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the DRY principle in AI engineering systems, focusing on knowledge deduplication, change safety, and maintainability benefits across data pipelines, model definitions, and deployment configurations.

---

## Problem

State the engineering problem: When AI engineering systems replicate preprocessing logic, model hyperparameters, feature definitions, or deployment configurations across notebooks, training scripts, serving code, and monitoring dashboards, every change becomes a multi-file hunt for duplicates, introducing drift, inconsistency, and subtle bugs that manifest only in production.
...
* **Tags:** architecture, systems, maintainability, code-quality, configuration-management, refactoring
* **Aliases:** dont-repeat-yourself, single-source-of-truth, knowledge-deduplication, once-and-only-once, deduplication
* **Keywords:** dry, duplication, deduplication, single-source-of-truth, abstraction, reuse, normalization, change-amplification, configuration-drift, shared-library, canonical-definition
* **Search Tokens:** dry, dont repeat yourself, once and only once, knowledge duplication, code duplication, configuration duplication, single source of truth, canonical definition, shared library, abstraction, deduplication, change amplification
* **Difficulty:** Intermediate
* **Domain:** systems
* **Engineering Area:** software_engineering
* **Estimated Reading Time:** 15-20 minutes
* **Prerequisites:** None
* **Recommended Next:** separation-of-concerns, modularity, single-source-of-truth, abstraction-layers, configuration-as-code
* **Cross-Links:**
...
* `domain` - "systems"
* `difficulty` - "intermediate"
* `engineering_area` - "software_engineering"
