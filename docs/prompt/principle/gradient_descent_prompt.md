...
# AENS Principle Resource Prompt — Gradient Descent
...
* **Target Principle Name:** `Gradient Descent`
* **Principle Category:** `optimization`
* **Problem Statement:** AI models fail to converge or converge to suboptimal solutions when engineers do not understand how gradient-based optimization behaves, leading to unstable training, poor loss landscapes, and failed production deployments.
...
Never explain:
* what gradient descent means in general
* basic software engineering concepts
* beginner API concepts
* what "gradient descent" is at a basic level
...
> **"What is the Gradient Descent principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the Gradient Descent principle in AI engineering systems, focusing on convergence behavior, optimization stability, and training efficiency benefits.

---

## Problem

State the engineering problem: When AI models are trained without understanding how gradient descent interacts with loss landscape geometry, learning rate schedules, and batch statistics, training becomes unstable, converges to poor minima, or fails entirely, making systems unreliable and computationally wasteful.
...
1. Principle category is exactly **optimization**.
