...
# AENS Principle Resource Prompt — KISS
...
* **Target Principle Name:** `KISS`
* **Principle Category:** `systems`
* **Problem Statement:** AI engineering systems become brittle and difficult to reason about when engineers introduce unnecessary complexity—over-engineered architectures, premature abstraction, or excessive indirection—leading to extended onboarding times, subtle interaction bugs, and systems that are harder to debug than the problems they solve.
...
Never explain:
* what KISS means in general
* basic software engineering concepts
* beginner API concepts
* what "KISS" is at a basic level
...
> **"What is the KISS principle, why does it matter for AI engineering systems, and how can I identify and apply it correctly?"**
...
Provide a 2-4 sentence overview describing the KISS principle in AI engineering systems, focusing on simplicity as a deliberate design constraint, reduced cognitive load, and the engineering value of solutions that are easy to understand, modify, and debug under production pressure.

---

## Problem

State the engineering problem: When AI engineering teams default to complex architectures—multi-stage pipelines, custom orchestration layers, or over-parameterized models—without evidence that the complexity is warranted, the resulting systems accumulate accidental complexity that obscures failure modes, slows iteration, and makes safe changes prohibitively expensive.
...
* **Tags:** architecture, systems, simplicity, design-principles, maintainability, cognitive-load
* **Aliases:** keep-it-simple, simplicity-principle, minimal-design, essential-complexity, avoid-overengineering
* **Keywords:** kiss, simplicity, minimalism, essential-complexity, accidental-complexity, over-engineering, premature-abstraction, cognitive-load, readability, maintainability, parsimony, occams-razor
* **Search Tokens:** kiss, keep it simple, keep it simple stupid, simplicity principle, minimal design, essential complexity, accidental complexity, over engineering, premature abstraction, cognitive load, readability, parsimony, occams razor
* **Difficulty:** Intermediate
* **Domain:** systems
* **Engineering Area:** software_engineering
* **Estimated Reading Time:** 15-20 minutes
* **Prerequisites:** None
* **Recommended Next:** dry, separation-of-concerns, modularity, yagni, occams-razor
* **Cross-Links:**
