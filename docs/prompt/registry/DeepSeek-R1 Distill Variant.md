# AENS Registry Resource Prompt — DeepSeek-R1 Distill Variant
...
* **Target Model Name:** DeepSeek-R1 Distill 7B / 8B / 14B / 32B
* **Task:** LLM
* **Category:** models
* **Provider:** DeepSeek
* **Family:** DeepSeek
...
* **Architecture:** Decoder-only Transformer distilled from DeepSeek-R1 with reasoning capabilities
* **Precision:** FP16/INT8/INT4/INT3 quantization support
...
* `id` - Use "7b", "8b", "14b", or "32b"
* `title` - "DeepSeek-R1 Distill 7B / 8B / 14B / 32B"
* `slug` - "deepseek-r1-distill-7b", "deepseek-r1-distill-8b", "deepseek-r1-distill-14b", or "deepseek-r1-distill-32b"
* `description` - Brief description of this variant
* `name` - "DeepSeek-R1 Distill 7B / 8B / 14B / 32B"
* `family_id` - "deepseek-r1-family"
