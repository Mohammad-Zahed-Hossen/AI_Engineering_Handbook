# AENS Registry Resource Prompt — DeepSeek Variant
...
* **Target Model Name:** DeepSeek-R1-0528
* **Task:** LLM
* **Category:** models
...
* **Architecture:** Decoder-only Transformer with Mixture-of-Experts (MoE) with similar scale to R1 (hundreds of billions total parameters, tens of billions active per token), Multi-Head Latent Attention (MLA), explicit "thinking mode" / chain-of-thought reasoning support, and enhanced function/tool calling capabilities
* **Precision:** FP8/BF16 native, INT8/INT4/INT3 quantization support
* **Use Case:** Production LLM deployment for reasoning with improved function/tool calling, agent frameworks, and tool-rich agent pipelines
