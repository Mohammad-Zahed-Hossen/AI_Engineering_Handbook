# AENS Registry Resource Prompt — DeepSeek-Coder Variant
...
* **Target Model Name:** DeepSeek-Coder 6.7B / 33B
* **Task:** LLM
* **Category:** models
* **Provider:** DeepSeek
* **Family:** DeepSeek
...
* **Architecture:** Decoder-only Transformer optimized for code generation
...
* `id` - Use "6.7b" or "33b"
* `title` - "DeepSeek-Coder 6.7B / 33B"
* `slug` - "deepseek-coder-6.7b" or "deepseek-coder-33b"
* `description` - Brief description of this variant
* `name` - "DeepSeek-Coder 6.7B / 33B"
* `family_id` - "deepseek-coder-family"
