    ...
    >
      ...
      <header id="summary" className="space-y-3 border-b border-border pb-4 scroll-mt-24">
        ...
        <div className="rounded-lg bg-muted/30 p-3.5 border border-border/80">
         ...
         <Prose content={model.decisionsummary.summary} className="content-prose text-sm sm:text-base font-medium text-foreground leading-relaxed" />
      </header>

      <SectionCard
        id="decision-guide"
        title="Decision Board & Tradeoffs"
