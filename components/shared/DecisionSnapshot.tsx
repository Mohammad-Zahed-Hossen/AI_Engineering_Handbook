...
export default function DecisionSnapshot({ guide }: DecisionSnapshotProps) {
  if (!guide.default_recommendation && !guide.one_sentence_summary) return null;

  return (
    <section id="decision-snapshot" className="space-y-3 scroll-mt-24">
      ...
      <div className="space-y-3">
        {/* Default Recommendation - Prominent */}
        ...
        {/* Choose When / Avoid When - Compact Grid */}
